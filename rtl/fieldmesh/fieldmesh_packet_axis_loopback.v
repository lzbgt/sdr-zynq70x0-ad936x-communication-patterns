// FieldMesh packet AXI-stream loopback shell.
//
// This simulation shell wires the packet-memory stream source to the matching
// stream sink with separate local TX/RX packet memories. It is the boundary
// before replacing the internal stream wire with a real DMA or IIO-facing
// adapter.

`timescale 1ns/1ps

module fieldmesh_packet_axis_loopback #(
...
wire [7:0] axis_tdata;
wire axis_tlast;
wire [7:0] axis_tuser_class;
wire [7:0] axis_tuser_mode;
wire [15:0] axis_tuser_stream_id;
wire [15:0] axis_tuser_slot;
wire sink_mem_wr_en;
...
fieldmesh_packet_axis_source #(
    ...
    .m_axis_tuser_class(axis_tuser_class),
    .m_axis_tuser_mode(axis_tuser_mode),
    .m_axis_tuser_stream_id(axis_tuser_stream_id),
    .m_axis_tuser_slot(axis_tuser_slot),
...
fieldmesh_packet_axis_sink #(
    ...
    .s_axis_tuser_class(axis_tuser_class),
    .s_axis_tuser_mode(axis_tuser_mode),
    .s_axis_tuser_stream_id(axis_tuser_stream_id),
    .s_axis_tuser_slot(axis_tuser_slot),
