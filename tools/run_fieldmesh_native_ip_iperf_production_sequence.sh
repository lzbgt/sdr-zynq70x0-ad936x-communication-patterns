...
report = {
    ...
    "requires_iio_native_iio_burst_state_daemon_libiio_execution": evidence.get("requires_iio_native_iio_burst_state_daemon_libiio_execution"),
    ...
    "requires_iio_state_daemon_libiio_transfer_worker": evidence.get("requires_iio_state_daemon_libiio_transfer_worker"),
    ...
    "board_iio_bridge_python_pipeline_role": evidence.get("board_iio_bridge_python_pipeline_role"),
    "host_iio_bridge_python_pipeline_role": evidence.get("host_iio_bridge_python_pipeline_role"),
    "board_iio_bridge_python_test_glue_only": evidence.get("board_iio_bridge_python_test_glue_only"),
    "host_iio_bridge_python_test_glue_only": evidence.get("host_iio_bridge_python_test_glue_only"),
    "board_iio_bridge_python_performance_critical_pipeline": evidence.get("board_iio_bridge_python_performance_critical_pipeline"),
    "host_iio_bridge_python_performance_critical_pipeline": evidence.get("host_iio_bridge_python_performance_critical_pipeline"),
    "board_iio_bridge_performance_critical_pipeline_owner": evidence.get("board_iio_bridge_performance_critical_pipeline_owner"),
    "host_iio_bridge_performance_critical_pipeline_owner": evidence.get("host_iio_bridge_performance_critical_pipeline_owner"),
    "board_iio_bridge_production_data_plane": evidence.get("board_iio_bridge_production_data_plane"),
    "host_iio_bridge_production_data_plane": evidence.get("host_iio_bridge_production_data_plane"),
    "board_iio_bridge_c_iio_helper_role": evidence.get("board_iio_bridge_c_iio_helper_role"),
    "host_iio_bridge_c_iio_helper_role": evidence.get("host_iio_bridge_c_iio_helper_role"),
    "board_iio_bridge_c_iio_helper_test_glue_only": evidence.get("board_iio_bridge_c_iio_helper_test_glue_only"),
    "host_iio_bridge_c_iio_helper_test_glue_only": evidence.get("host_iio_bridge_c_iio_helper_test_glue_only"),
    "board_iio_bridge_c_iio_helper_production_data_plane": evidence.get("board_iio_bridge_c_iio_helper_production_data_plane"),
    "host_iio_bridge_c_iio_helper_production_data_plane": evidence.get("host_iio_bridge_c_iio_helper_production_data_plane"),
    "board_iio_bridge_firmware_fpga_production_data_plane_required": evidence.get("board_iio_bridge_firmware_fpga_production_data_plane_required"),
    "host_iio_bridge_firmware_fpga_production_data_plane_required": evidence.get("host_iio_bridge_firmware_fpga_production_data_plane_required"),
    "board_iio_bridge_native_ip_fw_dma_data_plane_required": evidence.get("board_iio_bridge_native_ip_fw_dma_data_plane_required"),
    "host_iio_bridge_native_ip_fw_dma_data_plane_required": evidence.get("host_iio_bridge_native_ip_fw_dma_data_plane_required"),
    "board_iio_bridge_native_ip_fw_dma_data_plane_proven": evidence.get("board_iio_bridge_native_ip_fw_dma_data_plane_proven"),
    "host_iio_bridge_native_ip_fw_dma_data_plane_proven": evidence.get("host_iio_bridge_native_ip_fw_dma_data_plane_proven"),
    "board_iio_bridge_native_ip_fw_dma_data_plane_status_polls": evidence.get("board_iio_bridge_native_ip_fw_dma_data_plane_status_polls"),
    "host_iio_bridge_native_ip_fw_dma_data_plane_status_polls": evidence.get("host_iio_bridge_native_ip_fw_dma_data_plane_status_polls"),
    "board_iio_bridge_native_ip_fw_dma_data_plane_failures": evidence.get("board_iio_bridge_native_ip_fw_dma_data_plane_failures"),
    "host_iio_bridge_native_ip_fw_dma_data_plane_failures": evidence.get("host_iio_bridge_native_ip_fw_dma_data_plane_failures"),
    "board_iio_bridge_native_ip_fw_dma_data_plane_status": evidence.get("board_iio_bridge_native_ip_fw_dma_data_plane_status"),
    "host_iio_bridge_native_ip_fw_dma_data_plane_status": evidence.get("host_iio_bridge_native_ip_fw_dma_data_plane_status"),
    ...
    "board_iio_native_iio_burst_state_daemon_libiio_execution_proven": evidence.get("board_iio_native_iio_burst_state_daemon_libiio_execution_proven"),
    "host_iio_native_iio_burst_state_daemon_libiio_execution_proven": evidence.get("host_iio_native_iio_burst_state_daemon_libiio_execution_proven"),
    "board_iio_native_iio_burst_state_daemon_libiio_execution_invocations": evidence.get("board_iio_native_iio_burst_state_daemon_libiio_execution_invocations"),
    "host_iio_native_iio_burst_state_daemon_libiio_execution_invocations": evidence.get("host_iio_native_iio_burst_state_daemon_libiio_execution_invocations"),
    ...
    "board_iio_state_daemon_iio_transport_execute_proven": evidence.get("board_iio_state_daemon_iio_transport_execute_proven"),
    "host_iio_state_daemon_iio_transport_execute_proven": evidence.get("host_iio_state_daemon_iio_transport_execute_proven"),
    "board_iio_state_daemon_iio_transport_executes": evidence.get("board_iio_state_daemon_iio_transport_executes"),
    "host_iio_state_daemon_iio_transport_executes": evidence.get("host_iio_state_daemon_iio_transport_executes"),
    "board_iio_state_daemon_iio_transport_libiio_transfer_worker_runs": evidence.get("board_iio_state_daemon_iio_transport_libiio_transfer_worker_runs"),
    "host_iio_state_daemon_iio_transport_libiio_transfer_worker_runs": evidence.get("host_iio_state_daemon_iio_transport_libiio_transfer_worker_runs"),
    "board_iio_state_daemon_iio_transport_direct_transfer_worker_proven": evidence.get("board_iio_state_daemon_iio_transport_direct_transfer_worker_proven"),
    "host_iio_state_daemon_iio_transport_direct_transfer_worker_proven": evidence.get("host_iio_state_daemon_iio_transport_direct_transfer_worker_proven"),
    "board_iio_state_daemon_iio_transport_direct_transfer_worker_runs": evidence.get("board_iio_state_daemon_iio_transport_direct_transfer_worker_runs"),
    "host_iio_state_daemon_iio_transport_direct_transfer_worker_runs": evidence.get("host_iio_state_daemon_iio_transport_direct_transfer_worker_runs"),
    "board_iio_state_daemon_iio_transport_helper_backed_executor": evidence.get("board_iio_state_daemon_iio_transport_helper_backed_executor"),
    "host_iio_state_daemon_iio_transport_helper_backed_executor": evidence.get("host_iio_state_daemon_iio_transport_helper_backed_executor"),
