...
cat >"$work_dir/native-ip-ready.json" <<'JSON'
{
  ...
  "board_iio_bridge_native_ip_fw_dma_data_plane_status": {"z203": {"ok": true, "native_ip_fw_dma_data_plane": 1, "native_ip_fw_dma_data_plane_proof": "FIELDMESH_NATIVE_IP_FW_DMA_DATA_PLANE v1", "native_ip_production_data_plane": 1, "production_data_plane_owner": "firmware_dma_c_fpga", "performance_critical_pipeline_owner": "c_firmware_fpga", "python_performance_critical_pipeline": 0, "python_production_data_plane": 0, "iio_hil_transfer_glue_only": 1, "iio_hil_production_data_plane": 0, "helper_backed_libiio_transfer_executor": 0, "firmware_packet_bridge": 1, "firmware_tun_bridge": 1, "firmware_tun_bridge_proof": "FIELDMESH_NATIVE_IP_FW_TUN_BRIDGE v1", "hot_path_language": "c", "uses_json_on_air": 0, "uses_iio_hil_helper_as_data_plane": 0, "next_boundary": "firmware_dma_descriptor_worker"}},
  ...
  "host_iio_bridge_native_ip_fw_dma_data_plane_status": {"z203": {"ok": true, "native_ip_fw_dma_data_plane": 1, "native_ip_fw_dma_data_plane_proof": "FIELDMESH_NATIVE_IP_FW_DMA_DATA_PLANE v1", "native_ip_production_data_plane": 1, "production_data_plane_owner": "firmware_dma_c_fpga", "performance_critical_pipeline_owner": "c_firmware_fpga", "python_performance_critical_pipeline": 0, "python_production_data_plane": 0, "iio_hil_transfer_glue_only": 1, "iio_hil_production_data_plane": 0, "helper_backed_libiio_transfer_executor": 0, "firmware_packet_bridge": 1, "firmware_tun_bridge": 1, "firmware_tun_bridge_proof": "FIELDMESH_NATIVE_IP_FW_TUN_BRIDGE v1", "hot_path_language": "c", "uses_json_on_air": 0, "uses_iio_hil_helper_as_data_plane": 0, "next_boundary": "firmware_dma_descriptor_worker"}},
