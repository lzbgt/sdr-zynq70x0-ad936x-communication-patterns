...
PY
    ...
    for token in \
        ...
        FIELDMESH_NATIVE_IP_FW_DMA_DESCRIPTOR_WORKER \
        FIELDMESH_NATIVE_IP_FW_DMA_DESCRIPTOR_WORKER_EXECUTE \
        FIELDMESH_NATIVE_IP_FW_DMA_UIO_DESCRIPTOR_WORKER \
        FIELDMESH_NATIVE_IP_FW_TUN_BRIDGE \
        native_ip_fw_dma_data_plane \
        native_ip_fw_dma_descriptor_worker \
        native_ip_fw_dma_descriptor_worker_execution \
        firmware_dma_c_fpga \
