...
REQUIRED_RTL = [
    ...
    "rtl/fieldmesh/fieldmesh_firmware_ring_desc_store.v",
    "rtl/fieldmesh/fieldmesh_firmware_packet_service_core.v",
    "rtl/fieldmesh/fieldmesh_firmware_packet_service_bank.v",
    ...
    "rtl/fieldmesh/fieldmesh_firmware_packet_bram_service_bank.v",
    "rtl/fieldmesh/fieldmesh_firmware_packet_bram_endpoint.v",
    "rtl/fieldmesh/fieldmesh_firmware_service_pump.v",
