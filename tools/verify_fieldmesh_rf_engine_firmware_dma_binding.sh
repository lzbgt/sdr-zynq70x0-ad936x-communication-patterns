...
required_checker_tokens = [
    ...
    "fieldmesh_iq_rx_cdc",
    "target-specific SYNTH_LIGHT profile",
    "explicit async CDC domains",
...
for token in (
    ...
    "continuous live ADC streams reacquire",
    "rawm4",
    "raw_count >= 3'd6",
