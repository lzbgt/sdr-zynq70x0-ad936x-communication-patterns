...
FIELDMESH_DEMO_SEED_PEERS=1 "$daemon_demo" serve 127.0.0.1 49124 37 3000 >"$daemon_log" &
daemon_pid=$!
sleep 0.2
...
if not any(row.get("event") == "sdk_daemon_end" and row.get("handled") == 37 for row in serve):
