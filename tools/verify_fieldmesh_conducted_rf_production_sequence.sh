...
board = {
    ...
    "tcp_final_exchange": {
        ...
        "ok": True,
        "phase": "board_to_board",
        "initial_client_rc": 0,
        "final_client_rc": 0,
        "client_sent_bytes": 262144,
        "iperf_timeout_s": 120,
        "final_exchange_grace_s": 60,
        "final_exchange_grace_started": False,
        "queue_quiet_grace_s": 120,
        "queue_quiet_grace_started": False,
        "queue_quiet_max_consecutive_s": 0,
        "control_drain_s": 45,
        "client_preserved_for_control_drain": False,
        "client_killed_after_control_drain": False,
        "completed_after_primary_timeout": False,
        "completed_without_grace": True,
    },
...
host = {
    **board,
    ...
    "tcp_final_exchange": {
        ...
        "ok": True,
        "phase": "host_pc",
        "initial_client_rc": 124,
        "final_client_rc": 0,
        "client_sent_bytes": 131072,
        "iperf_timeout_s": 120,
        "final_exchange_grace_s": 60,
        "final_exchange_grace_started": True,
        "queue_quiet_grace_s": 120,
        "queue_quiet_grace_started": True,
        "queue_quiet_max_consecutive_s": 8,
        "control_drain_s": 45,
        "client_preserved_for_control_drain": True,
        "client_killed_after_control_drain": False,
        "completed_after_primary_timeout": True,
        "completed_without_grace": False,
    },
    ...
    "tcp_control_drain": {
        ...
        "started": True,
        "duration_s": 45,
        "client_sent_bytes_before_timeout": 131072,
        "keeps_rf_bridge_running": True,
        "reason": "client_timed_out_after_sending_tcp_bytes",
        "server_exited_after_drain": True,
        "server_json_after_drain_path": "z103_iperf3_host_tcp_server_after_control_drain.json",
        "elapsed_s": 30,
    },
