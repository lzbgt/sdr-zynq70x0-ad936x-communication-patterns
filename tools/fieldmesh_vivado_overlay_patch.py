...
ad_connect GND fieldmesh_ctrl/fw_dma_service_latency_last_cycles
ad_connect GND fieldmesh_ctrl/fw_dma_service_latency_max_cycles
ad_connect GND fieldmesh_ctrl/fw_dma_service_latency_accum_cycles
ad_connect GND fieldmesh_ctrl/fw_dma_service_latency_over_budget
ad_connect GND fieldmesh_ctrl/fw_dma_service_latency_over_budget_count
...
ad_connect GND fieldmesh_ctrl/qpsk_sync_output_byte_count
ad_connect GND fieldmesh_ctrl/qpsk_sync_lock_count
ad_connect GND fieldmesh_ctrl/qpsk_sync_slip_count
ad_connect GND fieldmesh_ctrl/qpsk_sync_rotation_count
ad_connect GND fieldmesh_ctrl/qpsk_sync_search_drop_count
ad_connect GND fieldmesh_ctrl/qpsk_rx_packet_count
ad_connect GND fieldmesh_ctrl/qpsk_rx_byte_count
ad_connect GND fieldmesh_ctrl/qpsk_rx_drop_count
ad_connect GND fieldmesh_ctrl/qpsk_rx_crc_error_count
ad_connect GND fieldmesh_ctrl/qpsk_rx_resync_count
ad_connect GND fieldmesh_ctrl/qpsk_rx_fault
ad_connect GND fieldmesh_ctrl/qpsk_demod_symbol_count
ad_connect GND fieldmesh_ctrl/qpsk_demod_low_margin_symbol_count
ad_connect GND fieldmesh_ctrl/qpsk_demod_tie_symbol_count
ad_connect GND fieldmesh_ctrl/qpsk_demod_min_symbol_margin
ad_connect GND fieldmesh_ctrl/qpsk_demod_margin_accum
ad_connect GND fieldmesh_ctrl/qpsk_demod_output_stall_cycle_count
ad_connect GND fieldmesh_ctrl/qpsk_demod_input_backpressure_cycle_count
...
ad_connect GND fieldmesh_ctrl/qpsk_timing_input_sample_count
ad_connect GND fieldmesh_ctrl/qpsk_timing_output_symbol_count
ad_connect GND fieldmesh_ctrl/qpsk_timing_selected_phase
ad_connect GND fieldmesh_ctrl/qpsk_timing_phase_change_count
ad_connect GND fieldmesh_ctrl/qpsk_timing_margin_accum
ad_connect GND fieldmesh_ctrl/qpsk_timing_low_margin_count
ad_connect GND fieldmesh_ctrl/qpsk_timing_output_stall_cycle_count
ad_connect GND fieldmesh_ctrl/qpsk_timing_input_backpressure_cycle_count
"""
    return f"""
{BD_CTRL_BEGIN}
...
ad_connect fieldmesh_ctrl/fw_dma_service_latency_budget_cycles fieldmesh_fw_dma_endpoint/service_latency_budget_cycles
...
ad_connect fieldmesh_fw_dma_endpoint/service_latency_last_cycles fieldmesh_ctrl/fw_dma_service_latency_last_cycles
ad_connect fieldmesh_fw_dma_endpoint/service_latency_max_cycles fieldmesh_ctrl/fw_dma_service_latency_max_cycles
ad_connect fieldmesh_fw_dma_endpoint/service_latency_accum_cycles fieldmesh_ctrl/fw_dma_service_latency_accum_cycles
ad_connect fieldmesh_fw_dma_endpoint/service_latency_over_budget fieldmesh_ctrl/fw_dma_service_latency_over_budget
ad_connect fieldmesh_fw_dma_endpoint/service_latency_over_budget_count fieldmesh_ctrl/fw_dma_service_latency_over_budget_count
...
ad_connect sys_cpu_clk fieldmesh_qpsk_tx_whitener/clk
...
ad_connect fieldmesh_qpsk_timing_recovery/phase_change_count fieldmesh_ctrl/qpsk_timing_phase_change_count
ad_connect fieldmesh_qpsk_timing_recovery/timing_margin_accum fieldmesh_ctrl/qpsk_timing_margin_accum
ad_connect fieldmesh_qpsk_timing_recovery/low_timing_margin_count fieldmesh_ctrl/qpsk_timing_low_margin_count
ad_connect fieldmesh_qpsk_timing_recovery/output_stall_cycle_count fieldmesh_ctrl/qpsk_timing_output_stall_cycle_count
...
ad_connect fieldmesh_qpsk_timing_recovery/m_axis_tvalid fieldmesh_qpsk_demodulator/s_axis_tvalid
ad_connect fieldmesh_qpsk_demodulator/s_axis_tready fieldmesh_qpsk_timing_recovery/m_axis_tready
ad_connect fieldmesh_qpsk_timing_recovery/m_axis_tdata fieldmesh_qpsk_demodulator/s_axis_tdata
ad_connect fieldmesh_qpsk_timing_recovery/m_axis_tlast fieldmesh_qpsk_demodulator/s_axis_tlast
ad_connect fieldmesh_qpsk_demodulator/symbol_count fieldmesh_ctrl/qpsk_demod_symbol_count
ad_connect fieldmesh_qpsk_demodulator/low_margin_symbol_count fieldmesh_ctrl/qpsk_demod_low_margin_symbol_count
ad_connect fieldmesh_qpsk_demodulator/tie_symbol_count fieldmesh_ctrl/qpsk_demod_tie_symbol_count
ad_connect fieldmesh_qpsk_demodulator/min_symbol_margin fieldmesh_ctrl/qpsk_demod_min_symbol_margin
ad_connect fieldmesh_qpsk_demodulator/margin_accum fieldmesh_ctrl/qpsk_demod_margin_accum
ad_connect fieldmesh_qpsk_demodulator/output_stall_cycle_count fieldmesh_ctrl/qpsk_demod_output_stall_cycle_count
...
ad_connect axi_ad9361/rst fieldmesh_qpsk_byte_sync/rst
ad_connect VCC fieldmesh_qpsk_byte_sync/enable
ad_connect fieldmesh_qpsk_demodulator/m_axis_tvalid fieldmesh_qpsk_byte_sync/s_axis_tvalid
ad_connect fieldmesh_qpsk_byte_sync/s_axis_tready fieldmesh_qpsk_demodulator/m_axis_tready
ad_connect fieldmesh_qpsk_demodulator/m_axis_tdata fieldmesh_qpsk_byte_sync/s_axis_tdata
ad_connect fieldmesh_qpsk_demodulator/m_axis_tlast fieldmesh_qpsk_byte_sync/s_axis_tlast
ad_connect fieldmesh_qpsk_byte_sync/sync_locked fieldmesh_ctrl/qpsk_sync_locked
ad_connect fieldmesh_qpsk_byte_sync/selected_phase fieldmesh_ctrl/qpsk_sync_selected_phase
ad_connect fieldmesh_qpsk_byte_sync/selected_rotation fieldmesh_ctrl/qpsk_sync_selected_rotation
ad_connect fieldmesh_qpsk_byte_sync/input_byte_count fieldmesh_ctrl/qpsk_sync_input_byte_count
ad_connect fieldmesh_qpsk_byte_sync/output_byte_count fieldmesh_ctrl/qpsk_sync_output_byte_count
ad_connect fieldmesh_qpsk_byte_sync/sync_lock_count fieldmesh_ctrl/qpsk_sync_lock_count
ad_connect fieldmesh_qpsk_byte_sync/sync_slip_count fieldmesh_ctrl/qpsk_sync_slip_count
ad_connect fieldmesh_qpsk_byte_sync/sync_rotation_count fieldmesh_ctrl/qpsk_sync_rotation_count
...
ad_connect axi_ad9361/l_clk fieldmesh_qpsk_rx_dewhitener/clk
ad_connect axi_ad9361/rst fieldmesh_qpsk_rx_dewhitener/rst
ad_connect VCC fieldmesh_qpsk_rx_dewhitener/enable
ad_connect fieldmesh_qpsk_byte_sync/m_axis_tvalid fieldmesh_qpsk_rx_dewhitener/s_axis_tvalid
ad_connect fieldmesh_qpsk_rx_dewhitener/s_axis_tready fieldmesh_qpsk_byte_sync/m_axis_tready
ad_connect fieldmesh_qpsk_byte_sync/m_axis_tdata fieldmesh_qpsk_rx_dewhitener/s_axis_tdata
ad_connect fieldmesh_qpsk_byte_sync/m_axis_tlast fieldmesh_qpsk_rx_dewhitener/s_axis_tlast
...
ad_connect fieldmesh_qpsk_rx_dewhitener/m_axis_tvalid fieldmesh_rx_header_framer/s_axis_tvalid
ad_connect fieldmesh_rx_header_framer/s_axis_tready fieldmesh_qpsk_rx_dewhitener/m_axis_tready
...
ad_connect fieldmesh_rx_header_framer/packet_count fieldmesh_ctrl/qpsk_rx_packet_count
ad_connect fieldmesh_rx_header_framer/byte_count fieldmesh_ctrl/qpsk_rx_byte_count
ad_connect fieldmesh_rx_header_framer/drop_count fieldmesh_ctrl/qpsk_rx_drop_count
ad_connect fieldmesh_rx_header_framer/crc_error_count fieldmesh_ctrl/qpsk_rx_crc_error_count
ad_connect fieldmesh_rx_header_framer/resync_count fieldmesh_ctrl/qpsk_rx_resync_count
ad_connect fieldmesh_rx_header_framer/fault fieldmesh_ctrl/qpsk_rx_fault
...
def patch_system_bd(
    ...
    if (
        "fieldmesh_qpsk_symbolizer" in text
        or "fieldmesh_bpsk_symbolizer" in text
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--rf-engine-overlay",
        action="store_true",
        help="also add non-transmitting fieldmesh_qpsk_symbolizer and IQ TX guard cells behind the sidecar DMA/bridge TX packet path",
    )
    parser.add_argument(
        "--gnss-uart-emio",
        action="store_true",
