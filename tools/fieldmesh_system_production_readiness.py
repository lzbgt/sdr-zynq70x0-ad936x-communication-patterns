...
def summarize(args: argparse.Namespace) -> dict[str, Any]:
    ...
    if args.native_ip_iperf_sequence:
        ...
        detail["native_ip_requires_iio_native_iio_burst_state_daemon_libiio_execution"] = (
            native_ip.get("requires_iio_native_iio_burst_state_daemon_libiio_execution") is True
        )
        ...
        detail["native_ip_requires_iio_native_iio_burst_state_daemon_transport_modem_profile"] = (
            native_ip.get(
        ...
        detail["native_ip_board_iio_native_iio_burst_state_daemon_libiio_execution_proven"] = (
            native_ip.get("board_iio_native_iio_burst_state_daemon_libiio_execution_proven")
            is True
        )
        detail["native_ip_host_iio_native_iio_burst_state_daemon_libiio_execution_proven"] = (
            native_ip.get("host_iio_native_iio_burst_state_daemon_libiio_execution_proven")
            is True
        )
        ...
        detail["native_ip_board_iio_native_iio_burst_state_daemon_transport_modem_profile_proven"] = (
            native_ip.get(
                "board_iio_native_iio_burst_state_daemon_transport_modem_profile_proven"
            )
            is True
        )
        detail["native_ip_host_iio_native_iio_burst_state_daemon_transport_modem_profile_proven"] = (
            native_ip.get(
        ...
        detail["native_ip_board_iio_bridge_phy_adaptive_mcs_decision"] = (
            native_ip.get("board_iio_bridge_phy_adaptive_mcs_decision")
        )
        detail["native_ip_host_iio_bridge_phy_adaptive_mcs_decision"] = (
            native_ip.get("host_iio_bridge_phy_adaptive_mcs_decision")
        )
        detail["native_ip_board_iio_bridge_phy_adaptive_mcs_live_quality_bound"] = (
            native_ip.get("board_iio_bridge_phy_adaptive_mcs_live_quality_bound")
            is True
        )
        detail["native_ip_host_iio_bridge_phy_adaptive_mcs_live_quality_bound"] = (
            native_ip.get("host_iio_bridge_phy_adaptive_mcs_live_quality_bound")
            is True
        )
        detail["native_ip_board_iio_bridge_phy_adaptive_mcs_decision_polls"] = (
            native_ip.get("board_iio_bridge_phy_adaptive_mcs_decision_polls")
        )
        ...
        detail["native_ip_host_iio_bridge_phy_adaptive_mcs_pre_burst_live_quality_bound"] = (
            native_ip.get(
                "host_iio_bridge_phy_adaptive_mcs_pre_burst_live_quality_bound"
            )
        )
        detail["native_ip_board_iio_bridge_phy_adaptive_mcs_pre_burst_selection_polls"] = (
            native_ip.get(
                "board_iio_bridge_phy_adaptive_mcs_pre_burst_selection_polls"
            )
        )
        detail["native_ip_host_iio_bridge_phy_adaptive_mcs_pre_burst_selection_polls"] = (
            native_ip.get(
    ...
    if args.require_native_ip_iperf:
        if native_ip is None:
            ...
            if (
                native_ip.get("requires_iio_native_iio_burst_state_daemon_libiio_execution")
                is not True
            ):
