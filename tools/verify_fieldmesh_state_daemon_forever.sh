...
def query_iio_transport_execute_once():
    ...
    try:
        sock.sendto(
            ...
            b"frames=2 bytes=128 samples_per_symbol=4 bit_repeat=1",
            ("127.0.0.1", port),
        )
        data, _ = sock.recvfrom(4096)
    finally:
...
def query_modem_profile_decision_once():
    ...
    try:
        sock.sendto(
            ...
            b"primary_raw_bitrate_bps=768000 effective_raw_bitrate_bps=768000 "
...
expected = {
    ...
    "state_daemon_direct_libiio_transfer_worker_proof": "FIELDMESH_IIO_TRANSPORT_DIRECT_TRANSFER_WORKER v1",
...
expected_execute = {
    ...
    "direct_transfer_worker_runs": 1,
    "direct_transfer_worker_frames": 2,
    "direct_transfer_worker_bytes": 128,
    "starts_rf_tx": 0,
    "writes_hardware": 0,
    "commands_executed": 0,
...
expected_fw_dma = {
    ...
    "native_ip_fw_dma_uio_descriptor_worker_proof": "FIELDMESH_NATIVE_IP_FW_DMA_UIO_DESCRIPTOR_WORKER v1",
    "native_ip_fw_dma_uio_descriptor_worker_required": 1,
    "native_ip_fw_dma_uio_descriptor_worker_mapped": 0,
    "native_ip_fw_dma_uio_descriptor_worker_exercised": 0,
    "native_ip_fw_dma_uio_descriptor_worker_packets_pumped": 0,
    "native_ip_fw_dma_uio_descriptor_worker_packets_drained": 0,
    "native_ip_fw_dma_uio_descriptor_worker_bytes_enqueued": 0,
    "native_ip_fw_dma_uio_descriptor_worker_bytes_drained": 0,
    ...
    "native_ip_production_data_plane": 0,
...
for key in (
    ...
    "native_ip_fw_dma_uio_descriptor_worker_errors",
