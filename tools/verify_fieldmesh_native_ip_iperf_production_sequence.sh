...
cat >"$work_dir/board-real-rf.json" <<'JSON'
{
  ...
  "iio_bridge_native_ip_fw_dma_data_plane_status": {"z203": {"ok": true, "native_ip_fw_dma_data_plane": 1, "native_ip_fw_dma_data_plane_proof": "FIELDMESH_NATIVE_IP_FW_DMA_DATA_PLANE v1", "native_ip_fw_dma_descriptor_worker": 1, "native_ip_fw_dma_descriptor_worker_proof": "FIELDMESH_NATIVE_IP_FW_DMA_DESCRIPTOR_WORKER v1", "native_ip_fw_dma_descriptor_worker_self_test": 1, "native_ip_fw_dma_descriptor_worker_packets_pumped": 2, "native_ip_fw_dma_descriptor_worker_packets_drained": 2, "native_ip_fw_dma_descriptor_worker_bytes_enqueued": 72, "native_ip_fw_dma_descriptor_worker_bytes_drained": 72, "native_ip_fw_dma_descriptor_worker_tcp_control_priority": 1, "native_ip_fw_dma_descriptor_worker_udp_interactive_priority": 1, "native_ip_production_data_plane": 1, "production_data_plane_owner": "firmware_dma_c_fpga", "performance_critical_pipeline_owner": "c_firmware_fpga", "python_performance_critical_pipeline": 0, "python_production_data_plane": 0, "iio_hil_transfer_glue_only": 1, "iio_hil_production_data_plane": 0, "helper_backed_libiio_transfer_executor": 0, "firmware_packet_bridge": 1, "firmware_tun_bridge": 1, "firmware_tun_bridge_proof": "FIELDMESH_NATIVE_IP_FW_TUN_BRIDGE v1", "hot_path_language": "c", "uses_json_on_air": 0, "uses_iio_hil_helper_as_data_plane": 0, "next_boundary": "firmware_dma_descriptor_worker"}, "z103": {"ok": true, "native_ip_fw_dma_data_plane": 1, "native_ip_fw_dma_data_plane_proof": "FIELDMESH_NATIVE_IP_FW_DMA_DATA_PLANE v1", "native_ip_fw_dma_descriptor_worker": 1, "native_ip_fw_dma_descriptor_worker_proof": "FIELDMESH_NATIVE_IP_FW_DMA_DESCRIPTOR_WORKER v1", "native_ip_fw_dma_descriptor_worker_self_test": 1, "native_ip_fw_dma_descriptor_worker_packets_pumped": 2, "native_ip_fw_dma_descriptor_worker_packets_drained": 2, "native_ip_fw_dma_descriptor_worker_bytes_enqueued": 72, "native_ip_fw_dma_descriptor_worker_bytes_drained": 72, "native_ip_fw_dma_descriptor_worker_tcp_control_priority": 1, "native_ip_fw_dma_descriptor_worker_udp_interactive_priority": 1, "native_ip_production_data_plane": 1, "production_data_plane_owner": "firmware_dma_c_fpga", "performance_critical_pipeline_owner": "c_firmware_fpga", "python_performance_critical_pipeline": 0, "python_production_data_plane": 0, "iio_hil_transfer_glue_only": 1, "iio_hil_production_data_plane": 0, "helper_backed_libiio_transfer_executor": 0, "firmware_packet_bridge": 1, "firmware_tun_bridge": 1, "firmware_tun_bridge_proof": "FIELDMESH_NATIVE_IP_FW_TUN_BRIDGE v1", "hot_path_language": "c", "uses_json_on_air": 0, "uses_iio_hil_helper_as_data_plane": 0, "next_boundary": "firmware_dma_descriptor_worker"}},
