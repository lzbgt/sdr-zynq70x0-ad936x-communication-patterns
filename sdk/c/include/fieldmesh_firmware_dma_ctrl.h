...
static const uint32_t FIELDMESH_FW_DMA_STATUS_OFFSETS[FIELDMESH_FW_DMA_STATUS_REG_COUNT] = {
    FIELDMESH_FW_DMA_REG_CONTROL,
    FIELDMESH_FW_DMA_REG_STATUS,
    FIELDMESH_FW_DMA_REG_SERVICE_BUDGET,
    FIELDMESH_FW_DMA_REG_QUEUED_COUNT,
    FIELDMESH_FW_DMA_REG_SELECTED_WORD,
    FIELDMESH_FW_DMA_REG_TX_PARSER_PACKETS,
    FIELDMESH_FW_DMA_REG_TX_PARSER_DROPS,
    FIELDMESH_FW_DMA_REG_INGRESS_PACKETS,
    FIELDMESH_FW_DMA_REG_INGRESS_DROPS,
    FIELDMESH_FW_DMA_REG_EGRESS_PACKETS,
    FIELDMESH_FW_DMA_REG_EGRESS_DROPS,
    FIELDMESH_FW_DMA_REG_BRAM_ERRORS,
    FIELDMESH_FW_DMA_REG_PEER_MCS_RETRY,
    FIELDMESH_FW_DMA_REG_DESCRIPTOR_FLAGS,
    FIELDMESH_FW_DMA_REG_SEQ_SEED,
    FIELDMESH_FW_DMA_REG_TX_PARSER_BYTES,
    FIELDMESH_FW_DMA_REG_INGRESS_BYTES,
    FIELDMESH_FW_DMA_REG_INGRESS_DESC_PUBLISH,
    FIELDMESH_FW_DMA_REG_EGRESS_BYTES,
    FIELDMESH_FW_DMA_REG_MAC_TICKS,
    FIELDMESH_FW_DMA_REG_MAC_PUMP_STARTS,
    FIELDMESH_FW_DMA_REG_MAC_PUMP_DONES,
    FIELDMESH_FW_DMA_REG_BRAM_CRC_ERRORS,
    FIELDMESH_FW_DMA_REG_BRAM_BOUNDS_ERRORS,
