...
raw PHY ceiling too low. The current fast profile is BPSK 8-sample/repeat-1 in
both directions at 3.072 Msps, raising the raw modem PHY ceiling to 384 kbit/s
...
at or above 300 kbit/s, while `retry_fallback` remains available for stronger
