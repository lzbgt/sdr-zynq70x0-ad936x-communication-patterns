...
raw PHY ceiling too low. The current fast profile is BPSK 4-sample/repeat-1 in
both directions at 3.072 Msps, raising the raw modem PHY ceiling to 768 kbit/s
...
at or above 600 kbit/s, while `retry_fallback` remains available for stronger
