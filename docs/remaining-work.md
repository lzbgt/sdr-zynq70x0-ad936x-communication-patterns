...
- Consolidate the reviewed `design.md` production insight into implementation:
  ...
  boundaries with a ping-pong-buffered `fieldmesh_axis_header_framer`, and
  crosses recovered packets back to RX DMA. The `--rf-engine-overlay` Vivado gate now proves the sidecar
