...
| `0x230` | `FM_QPSK_TIMING_MARGIN_ACCUM` | accumulated phase-weighted matched-filter decision margin |
| `0x234` | `FM_QPSK_TIMING_LOW_MARGINS` | phase-weighted matched-filtered symbols below the timing margin threshold |
