SUMMARY = "Pluto-compatible runtime assets for SDR-Z203"
...
do_install() {
    board_dir="${SDR_Z203_VENDOR_FW}/buildroot/board/pluto"
    target_dir="${SDR_Z203_VENDOR_FW}/buildroot/output/target"
    ...
    install -m 0755 ${WORKDIR}/sdr-z203-pluto-preboot.sh ${D}${sysconfdir}/init.d/S20pluto-preboot
    install -m 0755 ${WORKDIR}/sdr-z203-usb-getty.sh ${D}${sysconfdir}/init.d/S24usb-getty
