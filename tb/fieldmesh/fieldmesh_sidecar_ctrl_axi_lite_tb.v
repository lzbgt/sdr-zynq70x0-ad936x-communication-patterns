...
fieldmesh_sidecar_ctrl_axi_lite #(
    ...
    .fw_dma_tx_parser_byte_count(32'd0),
    .fw_dma_tx_parser_drop_count(32'd0),
    .fw_dma_tx_parser_fault(1'b0),
    .fw_dma_ingress_packet_count(32'd0),
    .fw_dma_ingress_byte_count(32'd0),
    .fw_dma_ingress_desc_publish_count(32'd0),
    .fw_dma_ingress_drop_count(32'd0),
    .fw_dma_ingress_fault(1'b0),
    .fw_dma_egress_packet_count(32'd0),
    .fw_dma_egress_byte_count(32'd0),
    .fw_dma_egress_drop_count(32'd0),
    .fw_dma_egress_fault(1'b0),
    .fw_dma_mac_tick_count(32'd0),
    .fw_dma_mac_pump_start_count(32'd0),
    .fw_dma_mac_pump_done_count(32'd0),
    ...
    .qpsk_sync_locked(1'b0),
    .qpsk_sync_selected_phase(2'd0),
    .qpsk_sync_selected_rotation(2'd0),
    .qpsk_sync_input_byte_count(32'd0),
    .qpsk_sync_output_byte_count(32'd0),
    .qpsk_sync_lock_count(32'd0),
    .qpsk_sync_slip_count(32'd0),
    .qpsk_sync_rotation_count(32'd0),
    .qpsk_sync_search_drop_count(32'd0),
    .qpsk_rx_packet_count(32'd0),
    .qpsk_rx_byte_count(32'd0),
    .qpsk_rx_drop_count(32'd0),
    .qpsk_rx_crc_error_count(32'd0),
    .qpsk_rx_resync_count(32'd0),
    .qpsk_rx_fault(1'b0),
    .qpsk_demod_symbol_count(32'd0),
    .qpsk_demod_low_margin_symbol_count(32'd0),
    .qpsk_demod_tie_symbol_count(32'd0),
    .qpsk_demod_min_symbol_margin(32'd0),
