...
module fieldmesh_class_descriptor_rings_tb;
...
fieldmesh_class_descriptor_rings dut (
    .clk(clk),
    .rst(rst),
    .enable(enable),
...
task enqueue_desc;
    ...
    begin
        @(negedge clk);
        enqueue_packet_addr = 32'h5000_0000 + sequence;
        enqueue_packet_len = 16'd96 + sequence[7:0];
        enqueue_stream_id = 16'd30 + sequence[15:0];
        enqueue_traffic_class = traffic_class;
        enqueue_mode = 8'd4;
        enqueue_flags = 16'h0021;
        enqueue_epoch = 32'd200 + sequence;
